...
import diffpvc.DiffPrivacyClassifier;
import diffpvc.PrivacyAgent;
import diffpvc.PrivacyAgents.PrivacyAgentBudget;
import diffpvc.PrivacyBudgetExhaustedException;
import diffpvc.PrivateInstances;
...
public class SuLQID3
        ...
        */
       protected C45Attribute SuLQChooseAttribute(PrivateInstances data, List<C45Attribute> candidateAttributes) throws PrivacyBudgetExhaustedException
       {
