...
public class DiffPrivacyC45
       ...
       protected int maxNumValues(List<C45Attribute> attList)
       {
              int max=0;
       ...
       protected boolean EnoughInstancesToSplit(double estimatedNumInstances, double maxNumAttributeValues, double numClassValues)
       {
